                  ...
                  <div className={`border ${panelClass} rounded-2xl p-4 sm:p-5`}>
                    ...
                    <form onSubmit={submitCommunityPost} className="mt-4 space-y-3">
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        {communityEditingId ? <button type="button" onClick={cancelEditCommunityPost} className={`inline-flex rounded-full border px-5 py-3 text-sm font-bold ${subtleClass}`}>수정 취소</button> : null}
                      </div>
                    </form>
                  </div>
